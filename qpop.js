...
function nextFunction(buttonElement){
    console.log("element is ",buttonElement.parentElement);
    
    // look for skipTo ...
    skiptos = checkForSkips(buttonElement.parentElement)
    printQuestionQueue();
}
